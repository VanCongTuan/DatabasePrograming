...
addBtn.addEventListener('click', () => {
   ...
   @Html.DropDownList("MayBay", null, htmlAttributes: new { @class = "sanbay", @id = "sanbay", @name = "sanbay" })
                                                    </select>
                                                </td>
             ...
             if( row.querySelector("td") != null)
             {
                   if(row.querySelectorAll("td").length !=3 || i ==0 )
                    {  tableData.push({
                        ...
                        thoigiandung: row.querySelector("td").nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.textContent
                        });
                    }
                    else
                    {
